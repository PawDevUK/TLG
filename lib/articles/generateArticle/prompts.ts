...
6. Title should be repository name and short name of changes e.g Profit-radar - Updating syncing. !! Title should be descriptive of the changes and more specific !! Don't use Enhancement, Enhancements, Enhancing in title !!
7. Use only action-oriented language: start clauses with "Removed", "Added", "Updated", "Improved", "Corrected", "Refactored", "Simplified", or "Enhanced". Never use personal pronouns like "we", "I", "the team", or "us".
8. Completely ignore and never mention any changes to articles.js, package-lock.json, or README.md.
`;
